...
❌ Спроба write_file у неіснуючу директорію (спочатку create_directory!)
...
**ПРИКЛАД needs_split:**
❌ Складний: "Створи 10 CSV файлів з даними"
→ Потребує 10x write_file
→ Поверни: {"needs_split": true, "suggested_splits": ["Створити файли 1-5", "Створити файли 6-10"]}

✅ Простий: "Створи файл hello.txt на Desktop"
→ 1 tool: write_file
